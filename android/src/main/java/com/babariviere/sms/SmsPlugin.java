...
public class SmsPlugin {
  ...
  private static final String CHANNEL_SMS_STATUS =
  ...
  private static final String CHANNEL_QUER_CONT =
    "plugins.babariviere.com/queryContact";
  private static final String CHANNEL_QUER_CONT_PHOTO =
    "plugins.babariviere.com/queryContactPhoto";
  private static final String CHANNEL_UPDATE =
    "plugins.babariviere.com/updateSMS";
  private static final String CHANNEL_USER_PROFILE =
    "plugins.babariviere.com/userProfile";
  private static final String CHANNEL_SIM_CARDS =
    "plugins.babariviere.com/simCards";
  ...
  public static void registerWith(Registrar registrar) {
    registrar.addRequestPermissionsResultListener(
      Permissions.getRequestsResultsListener()
    );

    // SMS receiver
    final SmsReceiver receiver = new SmsReceiver(registrar);
    final EventChannel receiveSmsChannel = new EventChannel(
      registrar.messenger(),
      CHANNEL_RECV,
    ...
    final MethodChannel sendSmsChannel = new MethodChannel(
      registrar.messenger(),
      CHANNEL_SEND,
      JSONMethodCodec.INSTANCE
    );
    ...
    final MethodChannel querySmsChannel = new MethodChannel(
      registrar.messenger(),
      CHANNEL_QUER,
      JSONMethodCodec.INSTANCE
    );
    ...
    final MethodChannel queryContactChannel = new MethodChannel(
      registrar.messenger(),
      CHANNEL_QUER_CONT,
      JSONMethodCodec.INSTANCE
    );
    ...
    /// Contact Photo query
    final ContactPhotoQuery contactPhotoQuery = new ContactPhotoQuery(
      registrar
    );
    final MethodChannel queryContactPhotoChannel = new MethodChannel(
      registrar.messenger(),
    ...
    /// User Profile
    final UserProfileProvider userProfileProvider = new UserProfileProvider(
      registrar
    );
    final MethodChannel userProfileProviderChannel = new MethodChannel(
      registrar.messenger(),
